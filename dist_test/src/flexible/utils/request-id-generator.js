...
var RequestIdGenerator = function () {
    ...
    var _classThis;
    var RequestIdGenerator = _classThis = /** @class */ (function () {
        function RequestIdGenerator_1() {
            this.counter = 0;
        }
        /**
         ...
         */
        RequestIdGenerator_1.prototype.generate = function () {
            var timestamp = Date.now();
            var count = ++this.counter;
            var random = Math.random().toString(36).substring(2, 6);
            return "".concat(timestamp, "-").concat(count, "-").concat(random);
        };
        return RequestIdGenerator_1;
    }());
    __setFunctionName(_classThis, "RequestIdGenerator");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        RequestIdGenerator = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RequestIdGenerator = _classThis;
}();

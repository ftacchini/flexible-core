import "jasmine";
import { FlexibleRouter } from "../../../../src/extension-points/routing/router.interface";
    ...
    return () => {
        ...
        describe("with single filter", () => {
            ...
            it("should return pipelines for event with empty static filter", async () => {
                ...
                expect(result[0].getResource()).toBe(pipeline);
            ...
            it("should return pipelines for event with dynamic filter", async () => {
                ...
                //ASSERT
                expect(result.length).toBe(1);
                expect(result[0].getResource()).toBe(pipeline1);
